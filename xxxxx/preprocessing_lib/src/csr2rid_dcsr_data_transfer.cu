...
#include <cmath>
#include <string>
#include "csr2rid_dcsr_data_transfer.h"
...
void Csr2RidDcsrDataTransfer::transfer()
{
    ...
    for (int k = 0; k < iterations; k++)
    {
        ...
        cuda_graph_comm::cal_degree_and_zip_edge<<<edge_grid_size, block_size>>>(edge_count, vertex_count, d_degree_arr, d_edge_arr, d_src_arr, d_adj_arr);
        HRR(cudaDeviceSynchronize());
        ...
        thrust::device_ptr<uint64_t> d_edge_ptr((uint64_t *)d_edge_arr);
