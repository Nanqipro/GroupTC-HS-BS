...
template <typename T,  uint blockSize,  uint dataLength>
__device__ void conditionalWarpReduce(volatile T* sharedData);

template <typename T,  uint blockSize>
__device__ void warpReduce(T* __restrict__ outDataPtr, volatile T* __restrict__ sharedData);

template <typename T,  uint blockSize,  uint dataLength>
__device__ void conditionalReduce(volatile T* __restrict__ sharedData);

template <typename T,  uint blockSize>
__device__ void blockReduce(T* __restrict__ outGlobalDataPtr, volatile T* __restrict__ sharedData);
