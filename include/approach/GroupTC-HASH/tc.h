...
__global__ void grouptc_hash_high_degree(vertex_t *src_list, vertex_t *adj_list, index_t *beg_pos, uint edge_count, uint vertex_count,
                                         int *partition, unsigned long long *GLOBAL_COUNT, int T_Group, int *G_INDEX, int CHUNK_SIZE,
                                         int warpfirstvertex);

__global__ void grouptc_hash_low_degree(vertex_t *src_list, vertex_t *adj_list, index_t *beg_pos, uint edge_count, uint vertex_count,
                                        int *partition, unsigned long long *GLOBAL_COUNT, int T_Group, int *G_INDEX, int warpfirstedge,
